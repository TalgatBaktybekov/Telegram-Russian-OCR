...
ALPHABET = os.env('russianALPHABET')
PATH_TO_TRAIN_IMGDIR = os.env("PATH_TO_TRAIN_IMGDIR")
PATH_TO_TRAIN_LABELS = os.env("PATH_TO_TRAIN_LABELS")
PATH_TO_TEST_IMGDIR = os.env("PATH_TO_TEST_IMGDIR")
PATH_TO_TEST_LABELS = os.env("PATH_TO_TRAIN_LABELS")
...
print("The resulst of the testing are: \n", evaluate(model, test_loader))